...
def prep_measure_def(cluster_date=None, test=None, Date_Col=None, Measure=None, Identifier=None, Lift_Threshold=None,                                                                                                              #
  ...
  time_series_control.rename(columns={'P_Sales': 'Control_Measure'}, inplace=True)
  ...
  time_series_treatment.rename(columns={'P_Sales': 'Treatment_Measure'}, inplace=True)
  ...
  time_series = time_series[['P_Type','Date','Control_Measure','Treatment_Measure']]
  ...
  #Summary Stat.....
  p1p2 = p1p2_sales.copy()
  p1p2['U_Type'] = 'Control'
  p3p4 = p3p4_sales.copy()
  p3p4['U_Type'] = 'Treatment'

  summary = pd.concat([p1p2[['Identifier','Control_ID','U_Type','D_Measure']], p3p4[['Identifier','Control_ID','U_Type','D_Measure']]], axis=0, ignore_index=True)
  summary.rename(columns={'D_Measure':'Measure'}, inplace=True)
  #End of Summary Stat...                                                                                                                      
                                                                                                                                                                                                                         ###       #
  ...
  impact_df.loc[impact_df['Lift']>Lift_Threshold,'Above_Thres'] = 1                                                                                                                                   #                    #       #
                                                                                                                                                                                                                                   #
  return [impact_df, p_val, p4_sales, p2_sales, time_series, summary]                                                                                                                                                              #
                                                                                                                                                                                                                                   #
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
