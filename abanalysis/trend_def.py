...
import pandas as pd
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
def trend_def(data = None, Identifier = 'Store', Cluster = 'Cluster', Changed = 'Changed', Test = 'Test', var2pickneighbors=['Seasonality','Trend']):
  ...
  trend_df = data[[Identifier, Cluster, Changed, Test]+var2pickneighbors].copy()
